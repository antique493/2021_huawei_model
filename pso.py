...
class PSO:
    def __init__(self, dim, size, iter_num, x_max, max_vel, fit_func, best_fitness_value=float('Inf'), C1=2, C2=2, W=1):
        self.C1 = C1
        self.C2 = C2
        self.W = W
        self.dim = dim  # 粒子的维度
        ...
        # 对种群进行初始化
        self.Particle_list = [Particle(self.x_max, self.max_vel, self.dim, self.fit_func_) for i in range(self.size)]
    ...
    def update_pos(self, part):
        ...
        value = self.fit_func_(part.get_pos())
    ...
    def update(self):
        for i in range(self.iter_num):
            ...
            if i % 100 == 0:
                print("curr pso: ", i)
                print("res:", self.fitness_val_list[-1])
                print("pos: ", self.get_bestPosition())
